...
import (
	...
	"github.com/thetreep/go-swagger/examples/todo-list/restapi/operations"
	"github.com/thetreep/go-swagger/examples/todo-list/restapi/operations/todos"
)
...
func configureAPI(api *operations.TodoListAPI) http.Handler {
	...
	if api.TodosAddOneHandler == nil {
		api.TodosAddOneHandler = todos.AddOneHandlerFunc(
			func(params todos.AddOneParams, principal interface{}) middleware.Responder {
	...
	if api.TodosDestroyOneHandler == nil {
		api.TodosDestroyOneHandler = todos.DestroyOneHandlerFunc(
			func(params todos.DestroyOneParams, principal interface{}) middleware.Responder {
	...
	if api.TodosFindHandler == nil {
		api.TodosFindHandler = todos.FindHandlerFunc(
			func(params todos.FindParams, principal interface{}) middleware.Responder {
	...
	if api.TodosUpdateOneHandler == nil {
		api.TodosUpdateOneHandler = todos.UpdateOneHandlerFunc(
			func(params todos.UpdateOneParams, principal interface{}) middleware.Responder {
