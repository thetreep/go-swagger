...
import (
	...
	"github.com/thetreep/go-swagger/examples/stream-server/client"
	"github.com/thetreep/go-swagger/examples/stream-server/client/operations"
	"github.com/thetreep/go-swagger/examples/stream-server/models"
)
