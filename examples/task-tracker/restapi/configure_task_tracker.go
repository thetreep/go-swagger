...
import (
	...
	"github.com/thetreep/go-swagger/examples/task-tracker/restapi/operations"
	"github.com/thetreep/go-swagger/examples/task-tracker/restapi/operations/tasks"
)
...
func configureAPI(api *operations.TaskTrackerAPI) http.Handler {
	...
	if api.TasksAddCommentToTaskHandler == nil {
		api.TasksAddCommentToTaskHandler = tasks.AddCommentToTaskHandlerFunc(
			func(params tasks.AddCommentToTaskParams, principal interface{}) middleware.Responder {
	...
	if api.TasksCreateTaskHandler == nil {
		api.TasksCreateTaskHandler = tasks.CreateTaskHandlerFunc(
			func(params tasks.CreateTaskParams, principal interface{}) middleware.Responder {
	...
	if api.TasksDeleteTaskHandler == nil {
		api.TasksDeleteTaskHandler = tasks.DeleteTaskHandlerFunc(
			func(params tasks.DeleteTaskParams, principal interface{}) middleware.Responder {
	...
	if api.TasksGetTaskCommentsHandler == nil {
		api.TasksGetTaskCommentsHandler = tasks.GetTaskCommentsHandlerFunc(
			func(params tasks.GetTaskCommentsParams) middleware.Responder {
	...
	if api.TasksGetTaskDetailsHandler == nil {
		api.TasksGetTaskDetailsHandler = tasks.GetTaskDetailsHandlerFunc(
			func(params tasks.GetTaskDetailsParams) middleware.Responder {
	...
	if api.TasksListTasksHandler == nil {
		api.TasksListTasksHandler = tasks.ListTasksHandlerFunc(
			func(params tasks.ListTasksParams) middleware.Responder {
				return middleware.NotImplemented("operation tasks.ListTasks has not yet been implemented")
			},
		)
	}
	if api.TasksUpdateTaskHandler == nil {
		api.TasksUpdateTaskHandler = tasks.UpdateTaskHandlerFunc(
			func(params tasks.UpdateTaskParams, principal interface{}) middleware.Responder {
	...
	if api.TasksUploadTaskFileHandler == nil {
		api.TasksUploadTaskFileHandler = tasks.UploadTaskFileHandlerFunc(
			func(params tasks.UploadTaskFileParams, principal interface{}) middleware.Responder {
